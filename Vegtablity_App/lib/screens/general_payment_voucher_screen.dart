...
class GeneralPaymentVoucherScreen extends StatefulWidget {
  ...
  @override
  State<GeneralPaymentVoucherScreen> createState() =>
      _GeneralPaymentVoucherScreenState();
}

class _GeneralPaymentVoucherScreenState
    extends State<GeneralPaymentVoucherScreen> {
            ...
            return Padding(
              ...
              child: SizedBox(
                ...
                child: Column(
                  children: [
                    Text(
                      context.tr('gpv_choose_expense_account'),
  ...
  void _saveVoucher() async {
    ...
    if (_selectedTargetAccount == null) {
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(context.tr('gpv_expense_account_required'))));
      return;
    }
    ...
    try {
      ...
      if (resp.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(context.tr('gpv_save_print_success').replaceAll(
                  '{id}',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('gpv_screen_title')),
              ...
              : Padding(
                  ...
                  children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(context.tr('gpv_target_account_label'),
                                        style: const TextStyle(
                    ...
                    ElevatedButton.icon(
                      ...
                      label: Text(context.tr('gpv_save_button'),
                          style: const TextStyle(
                              fontSize: 18, fontWeight: FontWeight.bold)),
